        ...
        Padding(
          ...
          child: 
            Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.circle, size: 60, color: Color(0xffD9D9D9),),
                  onPressed: () {
          ...
          children: [
            Padding(padding: EdgeInsets.all(8),
              child:GestureDetector(
                ...
                child: Text('Flood Reports',style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),)  
              ),
              onTap: () {
                showDialog(context: context, 
                builder: (context) => AlertDialog(
                  title: Text("Flood Reports"),
                  content: Text("This is where the flood reports would be."),
                  actions: [
            ...
            Padding(padding: EdgeInsets.all(8),
              child: GestureDetector(
                ...
                width: 60,
                decoration: BoxDecoration(color: Color(0xffF3F3F3), borderRadius: BorderRadius.circular(37)),
                child: Text('Risks',style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),)  
              ),
              onTap: () {
                showDialog(context: context, 
                builder: (context) => AlertDialog(
                  title: Text("Risks"),
                  content: Text("This is where information about the risks would be."),
                  actions: [
                    TextButton(onPressed: () => Navigator.pop(context), 
                    child: Text("Ok"))
                  ],
              ...
              child: GestureDetector(
                ...
                width: 60,
                decoration: BoxDecoration(color: Color(0xffF3F3F3), borderRadius: BorderRadius.circular(37)),
                child: Text('Emergency Routes',style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),)  
              ),
              onTap: () {
                showDialog(context: context, 
                builder: (context) => AlertDialog(
                  title: Text("Emergency Routes"),
                  content: Text("This is where the emergency routes would be."),
                  actions: [
                    TextButton(onPressed: () => Navigator.pop(context), 
                    child: Text("Ok"))
                  ],
              ...
              child: GestureDetector(
                ...
                width: 60,
                decoration: BoxDecoration(color: Color(0xffF3F3F3), borderRadius: BorderRadius.circular(37)),
                child: Text('Water Levels',style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),)  
              ),
              onTap: () {
                showDialog(context: context, 
                builder: (context) => AlertDialog(
                  title: Text("Water Levels"),
                  content: Text("This is where information regarding water levels would be."),
                  actions: [
                    TextButton(onPressed: () => Navigator.pop(context), 
                    child: Text("Ok"))
                  ],
